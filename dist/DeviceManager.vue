<template>
    <v-layout row="" wrap="" style="height: 100%">
                            ...
                            <v-card style="width: 100%">
                                <v-expansion-panel v-if="Array.isArray(playlist)">
                                    <v-expansion-panel-content v-for="item in playlist">
                                        ...
                                        <v-card>
                                            <v-list>
                                                <v-list-tile v-for="cItem in item.content" avatar="" class="py-2" style="width: 100%">
                                                    <v-list-tile-avatar>
                                                        <i class="far fa-folder grid-icon"></i>
                                                    </v-list-tile-avatar>
                                                    <v-list-tile-content>
        ...
        <v-flex md3="" style="border-left: 1px solid #ddd;">
            <v-list dense="">
                <v-list-tile v-for="item in devices" @click="selectItem(item)" :class="{'selected-playlist':isSelected(item)}">
                    <v-list-tile-content>
